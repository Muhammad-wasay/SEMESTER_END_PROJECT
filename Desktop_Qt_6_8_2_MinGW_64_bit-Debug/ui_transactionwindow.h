...
public:
    ...
    void setupUi(QMainWindow *TransactionWindow)
    {
        ...
        label_2->setGeometry(QRect(260, 10, 361, 51));
        QFont font;
...
"color:#2b547d;}"));
        ...
        transaction_table->setGeometry(QRect(10, 80, 721, 401));
        QFont font1;
...
""));
        ...
        label->setGeometry(QRect(640, 10, 61, 61));
        ...
        label_5->setGeometry(QRect(0, 0, 731, 531));
